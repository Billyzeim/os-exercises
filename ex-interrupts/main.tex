...
λειτουργικού συστήματος να αντιστοιχίσει το σήμα του interrupt σε κάποιο ISR, δηλαδή μια ρουτίνα εξυπηρέτησής του (περισσότερα στο \ref{int-handling}).
...
Έπειτα, ο επεξεργαστής πρέπει να ξεκινήσει να εκτελεί μία ρουτίνα, ώστε να εξυπηρετήσει το Interrupt. Αυτές οι ρουτίνες ονομάζονται
...
Παρακάτω φαίνεται ένα stub της assembly, δηλαδή ένα κομμάτι κώδικα assembly που κάνει push στη μνήμη το state του cpu, καλεί το ISR,
επαναφέρει στους cpu registers τα αποθηκευμένα states και επαναφέρει την ροή εκτέλεσης. Η χρήση της assembly είναι απαραίτητη για να
διεξαχθούν οι παραπάνω ενέργειες, αλλά για λόγους ευκολίας γράφουμε τη λογική του ISR σε C και καλούμε τη συνάρτηση μέσω του assembly stub.

\begin{file}[idt.asm (Snippet)]
...
% ένα interrupts να διορθωθεί
% code snippet για isr και ένα assembly stub 
% να αναφέρω και τα ονόματα των αρχείων που βρίσκονται όλα αυτά
% naming σε skylos